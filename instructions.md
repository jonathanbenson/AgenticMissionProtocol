...
3.  Write your questions in this file. Format them clearly, leaving space for the human operator to write answers directly next to or below each question. For example:

    ```markdown
    **Question 1:** What is the target version for the database migration?
    **Answer:**

    **Question 2:** Are there any performance constraints for the new API endpoint?
    **Answer:**
    ```
